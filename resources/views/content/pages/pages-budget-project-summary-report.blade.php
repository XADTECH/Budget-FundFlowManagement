                    ...
                    <div class="modal-body">
                        <form id="updateSalaryForm-{{ $salary->id }}" action="{{ url('/pages/update-budget-project-salary/' . $salary->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="expense" name="expenses" value="{{ $salary->expenses }}" required>
                            </div>
                        ...
                        <form id="updateOverHeadCostForm-{{ $costOverhead->id }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control"
                                    id="cost_per_month-{{ $costOverhead->id }}" name="amount"
                                    step="any" value="{{ $costOverhead->amount }}" required>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateFinancialCostForm-{{ $financialCost->id }}"
                            ...
                            <div class="mb-3">
                                <label for="months-{{ $financialCost->id }}" class="form-label">Percentage</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateCapitalExpenseForm-{{ $capital->id }}"
                            ...
                            <div class="mb-3">
                                <label for="cost_per_month-{{ $capital->id }}" class="form-label">QUANTITY</label>
                                <input type="number" class="form-control"
                                    id="cost_per_month-{{ $capital->id }}" name="total_number"
                                    step="any" value="{{ $capital->total_number }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="noOfPerson-{{ $capital->id }}" class="form-label">COST</label>
                                <input type="number" class="form-control" id="noOfPerson-{{ $capital->id }}"
                                    name="cost" step="any" value="{{ $capital->cost }}"
                                    required>
                            </div>
