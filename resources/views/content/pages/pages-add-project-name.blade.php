...
<div class="row">
  ...
  <div class="row">
    <div class="col-sm-6">
      <input type="text" class="form-control" name="projectname" placeholder="Enter a Project Name" required />
    </div>
    <div class="col-sm-6">
      <input type="text" class="form-control" name="projectdetail" placeholder="Enter a Project Detail" required />
    </div>
  </div>
  ...
  <div class="table-responsive text-nowrap">
    <table class="table table-hover">
      ...
      <tbody class="table-border-bottom-0">
        <tr>
          <td><i class="bx bxl-angular bx-sm text-danger me-3"></i> <span class="fw-medium">713H</span></td>
