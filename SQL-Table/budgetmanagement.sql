...
CREATE TABLE `allocated_budget` (
  ...
  `committed_allocated_salary` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_facility_cost` decimal(15,2) NOT NULL DEFAULT '0.00',
  `committed_allocated_facility_cost` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_material_cost` decimal(15,2) NOT NULL DEFAULT '0.00',
  `committed_allocated_material_cost` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_cost_overhead` decimal(15,2) NOT NULL DEFAULT '0.00',
  `committed_allocated_cost_overhead` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_financial_cost` decimal(15,2) NOT NULL DEFAULT '0.00',
  `committed_allocated_financial_cost` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_capital_expenditure` decimal(15,2) NOT NULL DEFAULT '0.00',
  `committed_allocated_capital_expenditure` decimal(15,2) NOT NULL DEFAULT '0.00',
  `allocated_budget` decimal(15,2) NOT NULL DEFAULT '0.00',
  `committed_allocated_budget` decimal(15,2) NOT NULL DEFAULT '0.00',
  `initial_allocation_budget` decimal(15,2) NOT NULL DEFAULT '0.00',
  `remaining_fund` decimal(10,2) DEFAULT '0.00',
  `committed_remaining_fund` decimal(10,2) DEFAULT '0.00',
...
INSERT INTO `allocated_budget` (`id`, `budget_project_id`, `total_salary`, `committed_allocated_salary`, `total_facility_cost`, `committed_allocated_facility_cost`, `total_material_cost`, `committed_allocated_material_cost`, `total_cost_overhead`, `committed_allocated_cost_overhead`, `total_financial_cost`, `committed_allocated_financial_cost`, `total_capital_expenditure`, `committed_allocated_capital_expenditure`, `allocated_budget`, `committed_allocated_budget`, `initial_allocation_budget`, `remaining_fund`, `committed_remaining_fund`, `total_dpm`, `total_lpo`, `reference_code`, `created_at`, `updated_at`) VALUES
(3, 5, 180000.00, 180000.00, 107000.00, 107000.00, 38000.00, 13000.00, 14000.00, 14000.00, 60000.00, 60000.00, 200000.00, 200000.00, 599000.00, 454000.00, 599000.00, 0.00, 0.00, 0.00, 0.00, 'BP100320240003', '2025-01-20 06:32:35', '2025-01-20 08:18:24');
...
(98, 5, 180000.00, 107000.00, 39200.00, 14922.10, 61572.00, 276100.00, 5276100.00, 3546548.37, 3897305.90, 'BP100320240003', '2025-01-20 06:31:51', '2025-01-20 06:32:07');
...
(97, 'ADCB', 'Khalifa St, Abu Dhabi', 'GB33BUKB20201555555555', '\"1234567890\"', 410000.00, 'BOFAUS3N', 'Abu Dhabi Main Branch', 'John Doe, johndoe@bank.com', 'UAE', 'Abu Dhabi', 0.00, '2024-11-08 00:47:25', '2025-01-02 07:40:12'),
(98, 'ADIB', 'Al Fahidi St, Dubai', 'US29WFAL100000123456789', '\"1234567890\"', 757950.00, 'WFBIUS6S', 'Dubai Downtown', 'Jane Smith, janesmith@wellsfargo.com', 'UAE', 'Dubai', 0.00, '2024-11-08 00:47:25', '2025-01-02 15:38:12'),
(99, 'EMIRATES NBD', 'Sheikh Zayed Rd, Sharjah', 'DE12CHASE2015050001234567', '\"1234567890\"', 394000.00, 'CHASUS33', 'Sharjah Lincoln Park', 'Mike Johnson, mikej@chase.com', 'UAE', 'Sharjah', 0.00, '2024-11-08 00:47:25', '2025-01-02 15:56:35'),
...
(5, 'BP100320240003', '2024-10-03', '2024-11-03', 6, 2, 19, 1, 'Dubai', 'abu hail, dubai', 'starting new Project', 'Etisalat Managed Service', 'UAE', '2024-10-03', 'approve', NULL, 599000.00, NULL, NULL, 33, 'Good', '2024-10-03 07:18:04', '2025-01-20 06:32:35');
...
(276, '2025-01-20', 'Initial Allocation', 'Salary', 'BP100320240003', 180000.00, 0.00, 180000.00, 180000.00, 5, '2025-01-20 06:32:35', '2025-01-20 06:32:35'),
(277, '2025-01-20', 'Initial Allocation', 'Facility', 'BP100320240003', 107000.00, 0.00, 107000.00, 107000.00, 5, '2025-01-20 06:32:35', '2025-01-20 06:32:35'),
(278, '2025-01-20', 'Initial Allocation', 'Material', 'BP100320240003', 38000.00, 0.00, 38000.00, 38000.00, 5, '2025-01-20 06:32:35', '2025-01-20 06:32:35'),
(279, '2025-01-20', 'Initial Allocation', 'Overhead', 'BP100320240003', 14000.00, 0.00, 14000.00, 14000.00, 5, '2025-01-20 06:32:35', '2025-01-20 06:32:35'),
(280, '2025-01-20', 'Initial Allocation', 'Financial', 'BP100320240003', 60000.00, 0.00, 60000.00, 60000.00, 5, '2025-01-20 06:32:35', '2025-01-20 06:32:35'),
(281, '2025-01-20', 'Initial Allocation', 'Capital Expenditure', 'BP100320240003', 200000.00, 0.00, 200000.00, 200000.00, 5, '2025-01-20 06:32:35', '2025-01-20 06:32:35');
...
(22, 5, 5, 'OverHead Cost', '5', 'OPEX', 'Annual Benefit', 0.59, '2024-10-03 07:20:51', '2025-01-20 03:56:27'),
...
(25, 5, 5, 'OverHead Cost', '5', 'OPEX', 'Depreciation Tools', 11504.17, '2024-10-03 07:20:51', '2025-01-20 03:56:27');
...
(9, 5, 5, 'Financial Cost', 'OPEX', '6', 'Risk', '0', 51310.00, '2024-10-03 07:20:51', '2025-01-20 03:56:27'),
(10, 5, 5, 'Financial Cost', 'OPEX', '6', 'Financial Cost', '0', 10262.00, '2024-10-03 07:20:51', '2025-01-20 03:56:27');
...
(82, '2024_12_10_095049_payment_order_items_table', 49),
(83, '2025_01_13_095258_create_distributions_table', 50),
(84, '2024_09_14_192846_create_allocated_budget_table', 51),
(85, '2024_09_14_192847_create_allocated_budget_table', 52);
...
(56, 'PO4264', 'Ali Asghar Hussani', 'Initial Investment', 'Abu Hail, UAE', 5, 200.00, 19, NULL, 33, '2025-01-20', 'cheque 30 days', 20990.00, 990.00, NULL, NULL, NULL, NULL, NULL, 'submitted', 1, '2025-01-20 08:03:08', '2025-01-20 08:09:22'),
(57, 'PO8320', 'Abazar Building Materail LLC Qusais', 'Interest On Loan', 'Abu Hail, UAE', 5, 50.00, 19, NULL, 33, '2025-01-20', 'cheque 60 days', 5397.50, 247.50, NULL, NULL, NULL, NULL, NULL, 'submitted', 1, '2025-01-20 08:15:42', '2025-01-20 08:18:24');
...
(27, 56, 'PO4264', '[{\"itemNo\":\"XAD2001\",\"description\":\"High-quality copper cable for electrical wiring.\",\"quantity\":40,\"unitPrice\":500,\"itemTotal\":20000,\"category\":\"material\",\"poNumber\":\"PO4264\",\"b_id\":5,\"discountValue\":1,\"vatValue\":5,\"totalAmount\":20990,\"deliveryCharges\":200,\"totalDiscount\":200,\"totalVAT\":990}]', NULL, 479000.00, 20990.00, 990.00, 200.00, 479000.00, 458010.00, 200.00, 0.00, '2025-01-20 08:09:22', '2025-01-20 08:09:22'),
(28, 57, 'PO8320', '[{\"itemNo\":\"XAD2004\",\"description\":\"High-quality copper cable for electrical wiring.\",\"quantity\":10,\"unitPrice\":500,\"itemTotal\":5000,\"category\":\"material\",\"poNumber\":\"PO8320\",\"b_id\":5,\"discountValue\":1,\"vatValue\":5,\"totalAmount\":5397.5,\"deliveryCharges\":200,\"totalDiscount\":50,\"totalVAT\":247.5}]', NULL, 459000.00, 5397.50, 247.50, 50.00, 459000.00, 453602.50, 200.00, 0.00, '2025-01-20 08:18:24', '2025-01-20 08:18:24');
...
(12, '01092025', 1, '2025-01-09 05:41:54', '2025-01-09 05:41:54'),
(13, '01142025', 1, '2025-01-14 08:11:38', '2025-01-14 08:11:38'),
(14, '01162025', 2, '2025-01-16 07:01:01', '2025-01-16 07:50:33'),
(15, '01172025', 4, '2025-01-17 08:52:34', '2025-01-17 12:58:40'),
(16, '01182025', 8, '2025-01-18 03:28:50', '2025-01-18 10:43:11');
...
ALTER TABLE `distributions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `distributions_project_id_head_unique` (`project_id`,`head`);
