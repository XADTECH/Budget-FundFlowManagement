...
public function updateBudget()
{
    ...
    $current_total_budget = FacilityCost::where('budget_project_id', $this->budget_project_id)
                                  ->sum('total_budget');

    $current_total_budget_allocated = FacilityCost::where('budget_project_id', $this->budget_project_id)
