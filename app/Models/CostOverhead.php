...
public function calculateTotalCost()
{
    ...
    if ($this->cost_per_month > 0) {
        ...
        // Case 4: Both staff and months are zero, total cost should be based on cost_per_month
        else {
...
public function calculateAverageCost()
{
    if ($this->no_of_staff > 0 && $this->no_of_months > 0) {
        ...
        $this->average_cost = $this->total_cost; // Or another default value, such as 0
    }
   ...
   public function updateBudget($expenseHead)
   {
       ...
       $approved_total_cost = CostOverhead::where('budget_project_id', $this->budget_project_id)
